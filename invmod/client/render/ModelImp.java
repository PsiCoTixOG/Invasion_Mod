...
public class ModelImp extends ModelBase
{
  ...
  public ModelImp(float f, float f1)
  {
    ...
    this.rhorn.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
    this.rhorn.setRotationPoint(-2.5F, 6.0F, -5.0F);
    this.rhorn.rotateAngleX = 0.0F;
    this.rhorn.rotateAngleY = 0.0F;
    this.rhorn.rotateAngleZ = 0.0F;
    this.rhorn.mirror = false;
    this.lhorn = new ModelRenderer(this, 0, 2);
    this.lhorn.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
    this.lhorn.setRotationPoint(0.5F, 6.0F, -5.0F);
    this.lhorn.rotateAngleX = 0.0F;
    this.lhorn.rotateAngleY = 0.0F;
    this.lhorn.rotateAngleZ = 0.0F;
